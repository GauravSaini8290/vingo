...
const FoodCard = ({ data }) => {
  ...
  return (
    <div className="w-[250px] rounded-2xl border-2 border-[#ff4d2d] bg-white shoadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col ">
      ...
      <div className="flex items-center justify-between mt-auto p-3">
        ...
        <div className="flex items-center border  rounded-full overflow-hidden shadow-sm">
          <button className="px-2 py-1 hover:bg-gray-100 transition">
            <FaMinus size={12} onClick={handledcress} />
          </button>
