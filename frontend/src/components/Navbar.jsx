  ...
  return (
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6]  overflow-visible">
      ...
      <div className="flex items-center gap-4">
        ...
        {showInfo && (
          <div
            className={`fixed top-[80px] right-[10px] ${userData.role === "deliveryBoy" ? "md:right-[30%] lg-right-[40%]" : "md:right-[25%]   lg-right-[25%]"} w-[180px]  bg-white shadow-xl rounded-xl p-[20px] flex flex-col gap-[10px] z-[9999]`}
          >
